...
**[Henrob tape feed riveting documentation.](https://www.atlascopco.com/en-er/itba/products/joining-solutions/self-pierce-riveting/henrob-tape-feed)**  
...
**[Henrob blow feed riveting documentation.](https://www.atlascopco.com/en-er/itba/products/joining-solutions/self-pierce-riveting/henrob-blow-feed)**  
...
Good documentation enhances learning through low effort and helps people problem solve effectively:

| Principle | Description |
|-----------|-------------|
| **Fast to scan** | Developers are usually in a hurry and need information quickly |
| **Copy-pasteable** | Working code examples are gold for immediate implementation |
| **Contextual** | Explain the "why" not just the "how" to build understanding |

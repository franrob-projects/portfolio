...
I completely rewrote Ably's [SSE documentation](https://ably.com/docs/protocols/sse), converting it from basic markdown to an interactive guide with working examples and troubleshooting steps.
...
Rebuilt the developer onboarding documentation to be more accessible while maintaining technical depth.
